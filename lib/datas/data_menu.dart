...
List<GojekMenu> ListGoMenu = [
  ...
  GojekMenu(icon: 'gosend', title: 'GoSend', color: green2),
  GojekMenu(icon: 'gomart', title: 'GoMart', color: red),
  GojekMenu(icon: 'gopulsa', title: 'GoPulsa', color: blue2),
  GojekMenu(icon: 'goclub', title: 'GoClub', color: purple),
  GojekMenu(icon: 'other', title: 'Lainnya', color: dark4),
];